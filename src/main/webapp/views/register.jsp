    ...
    <div class="col-sm-6">
        ...
        <form action="newuserregister" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control form-control-lg" rows="3" placeholder="Enter Your Address" name="address" required></textarea>
            </div>
<span style="margin-top: 10px">Already have an account <a class="linkControl" href="/">Login here</a></span> <br><br>
            <input type="submit" id="registerButton" value="Register" class="btn btn-primary btn-block"><br>
